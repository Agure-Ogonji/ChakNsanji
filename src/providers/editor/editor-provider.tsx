...
const addAnElement = (
    ...
    if(action.type !== 'ADD_ELEMENT')
        throw Error(
            'You have sent the wrong action type to the Add Element Editor State'
        )
...
const updateAnElement = (
    ...
    if(action.type !== 'UPDATE_ELEMENT'){
        throw Error('You Have Sent the Wrong Action Type To The Update Element State')
    }
    return editorArray.map((item)=>{
...
const deleteAnElement = (
    ...
    if(action.type !== 'DELETE_ELEMENT')
        throw Error('You Have Sent the Wrong Action Type to The Delete Element Editor State')
...
const editorReducer = (
    ...
    switch (action.type){
        case 'ADD_ELEMENT':
            ...
            //UPDATE THE HISTORY TO INCLUDE THE WHOLE UPDATED EDITORSTATE
        ...
        case 'DELETE_ELEMENT':
            ...
            const updateElementsAfterDelete = deleteAnElement(
                state.editor.elements,
                action
            )
            const updatedEditorStateAfterDelete = {
                ...state.editor,
                elements: updateElementsAfterDelete,
            }
...
const EditorProvider = (props: EditorProps) => {
    ...
    return (
        <EditorContext.Provider value={{
            state,dispatch, subaccountId: props.subaccountId,funnelId:props.funnelId, pageDetails: props.pageDetails
        }}>
            {props.children}
...
export const useEditor = () =>{
    ...
    if(!context){
        throw new Error('useEditor Hook Should Be Used in The Editor Provider')
    }
    return context
}
