...
const MenuOptions = ({
    details, id, sidebarLogo, sidebarOpt, subAccounts, user, defaultOpen,
}: Props) => {
    ...
    >
        ...
        <SheetContent showX={!defaultOpen} side={'left'} className={clsx('bg-background/80 backdrop-blur-xl fixed top-0 border-r-[1px] p-6',{
            ...
            <div>
                    ...
                    {!!subAccounts
                      ...
                      : 'No Accounts'}
                            ...
                            {(user?.role === 'AGENCY_OWNER' || user?.role === 'AGENCY_ADMIN') && (
                                <SheetClose>
                                    <Button className='w-50 items-center justify-between ml-5 flex gap-2' onClick={()=>{
                                        setOpen(
                                            <CustomModal title='Create Subaccount' subheading='You can switch between Agency & Subaccount from the sidebar'>
                ...
                <p className='text-muted-foreground text-ms mb-2'>MENU LINKS</p>
