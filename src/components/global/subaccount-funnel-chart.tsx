...
const SubaccountFunnelChart = ({data}: Props) => {
  return (
    <div className='h-fit flex transition-all items-chart'>
        <DonutChart className='h-40 w-40' data={data} category='totalFunnelVisits' index='name' colors={['blue-400', 'primary', 'blue-600', 'blue-700', 'blue-800']} showAnimation={true} customTooltip={customTooltip} variant='pie'/>
    </div>
  )
}
