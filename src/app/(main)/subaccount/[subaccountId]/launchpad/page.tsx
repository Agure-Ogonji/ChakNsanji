            ...
            <div className='w-full h-full max-w-[800px]'>
                <Card className='border-none'>
                    ...
                    <CardContent className='flex flex-col gap-4'>
                        <div className='flex justify-between items-center w-full h-20 border p-4 roudned-lg'>
                        ...
                        <div className='flex justify-between items-center w-full h-20 border p-4 rounded-lg'>
                            ...
                            {subaccountDetails.connectAccountId || connectedStripeAccount ? (
                                <CheckCheckIcon size={50} className='text-primary p-2 flex-shrink-0'/>
                            ) : (
                        ...
                        <div className='flex justify-between items-center w-full h-20 border p-4 rounded-lg'>
                            ...
                            {allDetailsExist ? (
                                ...
                                <Link href={`/subaccount/${subaccountDetails.id}/settings`} className='bg-primary py-2 px-4 rounded-md text-white'>
                                    Start
                                </Link>
                            )}
                        </div>
