...
import { AlignCenter, AlignHorizontalJustifyCenter, AlignHorizontalJustifyCenterIcon, AlignHorizontalJustifyEnd, AlignHorizontalJustifyEndIcon, AlignHorizontalJustifyStart, AlignHorizontalSpaceAround, AlignHorizontalSpaceBetween, AlignJustify, AlignLeft, AlignRight, AlignVerticalJustifyCenter, AlignVerticalJustifyStart, ChevronRightIcon, ChevronsLeftRightIcon, LucideImageDown } from 'lucide-react'
        ...
        <AccordionItem value='Typography' className='px-6 py-0 border-y-[1px]'>
                ...
                <AccordionContent className='flex flex-col gap-2'>
                    <div className='flex flex-col gap-2'>
                        ...
                        <Tabs onValueChange={(e)=>handleOnChanges({
                            target:{
                                id: 'textAlign',
                                value: e,
                            },
                    ...
                    <div className='flex gap-4'>
                        <div>
                            ...
                            <Select onValueChange={(e)=>handleOnChanges({
                                target:{
                                    id:'font-weight',
                                    value:e,
                                },
                                ...
                                <SelectTrigger className='w-[180px]'>
                                    <SelectValue placeholder="Select A Weight"></SelectValue>
                                </SelectTrigger>
                                <SelectContent>
                                    <SelectGroup>
                        ...
                        <div className='flex gap-4 flex-col'>
                            <div className='flex gap-4'>
                                ...
                                <div>
                                    ...
                                    <Input id='width' placeholder='px' onChange={handleOnChanges} value={state.editor.selectedElement.styles.width}/>
                                </div>
                            </div>
                        </div>
                        <p>Margin px</p>
                    ...
                    <div className='flex flex-col gap-2'>
                        ...
                        <div className='flex gap-4 flex-col'>
                            <div className='flex gap-4'>
                                <div>
                                    <Label className='text-muted-foreground'>Top</Label>
                                    <Input id='paddingTop' placeholder='px' onChange={handleOnChanges} value={state.editor.selectedElement.styles.paddingTop}/>
                                </div>
                                <div>
                                    <Label className='text-muted-foreground'>Bottom</Label>
                                    <Input id='paddingBottom' placeholder='px' onChange={handleOnChanges} value={state.editor.selectedElement.styles.paddingBottom}/>
                                </div>
                            </div>
                            <div className='flex gap-4'>
                                <div>
                                    <Label className='text-muted-foreground'>Left</Label>
                                    <Input id='paddingLeft' placeholder='px' onChange={handleOnChanges} value={state.editor.selectedElement.styles.paddingLeft}/>
                                </div>
                                <div>
                                    <Label className='text-muted-foreground'>Right</Label>
                                    <Input id='paddingRight' placeholder='px' onChange={handleOnChanges} value={state.editor.selectedElement.styles.paddingRight}/>
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <AccordionContent className='flex flex-col gap-4'>
                <div>
                    ...
                    <div className='flex items-center justify-end'>
                        <small className='p-2'>
                            {typeof state.editor.selectedElement.styles?.opacity === 'number' ? state.editor.selectedElement.styles?.opacity : parseFloat(
                                (
                    ...
                    defaultValue={[
                        typeof state.editor.selectedElement.styles?.opacity === 'number' ? state.editor.selectedElement.styles?.opacity : parseFloat(
                            (
                                state.editor.selectedElement.styles?.opacity || '0').replace('%', '')) || 0,]} max={100} step={1}/></div>
                <div>
                    <Label className='text-muted-foreground'>Border Radius</Label>
                    <div className='flex items-center justify-end'>
                        <small>
                            {typeof state.editor.selectedElement.styles?.borderRadius === 'number' ? state.editor.selectedElement.styles?.borderRadius: parseFloat(
                                (
                ...
                <AccordionContent className='flex flex-col gap-2'>
                    ...
                    <Label className='text-muted-foreground'>Align Items</Label>
                        ...
                        <div className='flex items-center gap-2'>
                            <Input className='h-4 w-4' placeholder='px' type='checkbox' id='display' onChange={(va)=>{
                                handleOnChanges({
                                    target:{
                                        id:'display',
