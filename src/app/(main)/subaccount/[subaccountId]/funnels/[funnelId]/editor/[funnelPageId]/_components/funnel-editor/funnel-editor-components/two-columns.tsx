...
const TwoColumns = (props: Props) => {
  ...
  return (
    <div style={props.element.styles} className={clsx(
        'relative p-4 transition-all', {
            ...
            'border-dashed border-[1px] border-slate-300': state.editor.selectedElement.id === props.element.id && !state.editor.liveMode,
        }
    )}
    id='innerContainer'
