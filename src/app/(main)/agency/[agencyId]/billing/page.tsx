  ...
  return (
    <>
        ...
        <div className='flex flex-col lg:!flex-row justify-between gap-8'>
            <PricingCard planExists={agencySubscription?.Subscription?.active === true}
                prices={prices.data}
                ...
                highlightDescription='Do You Want to modify your plan? You can do this here. If you have
          more questions contact support@chaKplura-app.com'
                highlightTitle='Plan Options'
                description={
                    agencySubscription?.Subscription?.active === true ? currentPlanDetails?.description || 'Let Us Get Started' : 'Let Us get started! Pick a plan that works best for you.'
                }
                duration='/month'
                features={
                ...
                title={
                    agencySubscription?.Subscription?.active === true ? currentPlanDetails?.title || 'Starter' : 'Starter'
                }
            />
            {addOns.data.map((addOn)=>(
                <PricingCard planExists={agencySubscription?.Subscription?.active === true}
                    ...
                    amt={
                        ...
                        //@ts-ignore
                        `$${addOn.default_price.unit_amount / 100}` : '$0'
                    }
                    buttonCta='Subscribe'
